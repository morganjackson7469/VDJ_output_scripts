...
vdj_pairmaster_jcvi <- read_excel("/home/morganjackson/bioinformatics/data/vdj_outputs/VDJserver_JCVIsamples_20250519/output/20250711_JCVI_pairmaster_corrected.xlsx")
...
Cys_group <- c("3094", "6527", "5873")
Cntrl_group <- c("1763", "2265", "3851")

csv_output_dir <- "/home/morganjackson/bioinformatics/data/vdj_outputs/VDJserver_JCVIsamples_20250519/output/csv_outputs"
plots_output_dir <- "/home/morganjackson/bioinformatics/data/vdj_outputs/VDJserver_JCVIsamples_20250519/output/ggplot_outputs_group"
...
pairmaster_df <- vdj_pairmaster_jcvi %>%
  mutate(group = case_when(
    BR_code %in% Cys_group ~ "Cysloop",
    BR_code %in% Cntrl_group ~ "Control"
  ), .after = 1)
