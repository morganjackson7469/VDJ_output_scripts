...
plots_output_dir <- "/home/morganjackson/bioinformatics/data/vdj_outputs/VDJserver_JCVIsamples_20250519/output/ggplot_outputs"
...
cysloop_controls <- vdj_pairmaster_jcvi %>%
  filter(BR_code %in% c("1763", "2265", "3851"))
...
labs(title = "IGHV Family Distribution in controls",
x = "V Gene Family", y = "Percentage (%)")
ggsave(filename = file.path(plots_output_dir, "V_fam_distribution_controls.png"),
       width = 6, height = 4)
...
labs(title = "IGHV Top 10 Genes in controls",
x = "V Top 10 Genes", y = "Count")
ggsave(filename = file.path(plots_output_dir, "V_genes_top10_controls.png"),
       width = 6, height = 4)
...
geom_bar(stat = "identity", fill = "steelblue") +
theme_grey(base_size = 14) +
labs(title = "IGHJ Family Distribution in controls",
x = "J Gene Family", y = "Percentage (%)")
ggsave(filename = file.path(plots_output_dir, "J_fam_distribution_controls.png"),
       width = 6, height = 4)
...
theme_grey(base_size = 14) +
theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
labs(title = "IGHJ Top 10 Genes in controls",
x = "J Top 10 Genes", y = "Count")
ggsave(filename = file.path(plots_output_dir, "J_genes_top10_controls.png"),
       width = 6, height = 4)
...
ggplot(top_vj_pairings, aes(x = reorder(VJ_only_gene, -n), y = n)) +
  ...
  theme_grey(base_size = 14) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Top 10 V:J pairs in controls",
       x = "V:J pairs", y = "Count")
ggsave(filename = file.path(plots_output_dir, "V:J_pairs_top10_controls.png"),
       width = 6, height = 4)
...
ggplot(heatmap_vj_pairs, aes(x = J_gene_mut, y = V_gene_mut, fill = n)) +
  ...
  labs(title = "VH:JH Gene Pairings",
       x = "JH Gene", y = "VH Gene", fill = "Count") +
  theme_grey()
ggsave(filename = file.path(plots_output_dir, "VH:JH_pairs_controls.png"),
        width = 6, height = 4)
...
ggplot(vj_pair_percentage_table, aes(x = reorder(VJ_only_gene, -percent), y = percent)) +
  ...
  theme_grey(base_size = 14) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "V:J pairs percentage in controls",
       x = "V:J pairs", y = "Percentage")
ggsave(filename = file.path(plots_output_dir, "V:J_pairs_percentage_controls.png"),
       width = 6, height = 4)
...
ggplot(K_fam_distribution, aes(x = KC_v_fam, y = distribution)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  theme_grey(base_size = 14) +
  labs(title = "IGKV Family Distribution in controls",
       x = "LC Kappa Gene Family", y = "Percentage (%)")
ggsave(filename = file.path(plots_output_dir, "K_fam_distribution_controls.png"),
       width = 6, height = 4)
...
theme_grey(base_size = 14) +
theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
labs(title = "IGKV Top 10 Genes in controls",
x = "KV Top 10 Genes", y = "Count")
ggsave(filename = file.path(plots_output_dir, "KV_genes_top10_controls.png"),
       width = 6, height = 4)
...
ggplot(L_fam_distribution, aes(x = LC_v_fam, y = distribution)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  theme_grey(base_size = 14) +
  labs(title = "IGLC Family Distribution in controls",
       x = "LC Lambda Gene Family", y = "Percentage (%)")
ggsave(filename = file.path(plots_output_dir, "L_fam_distribution_controls.png"),
       width = 6, height = 4)
...
theme_grey(base_size = 14) +
theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
labs(title = "IGLV Top 10 Genes in controls",
x = "LV Top 10 Genes", y = "Count")
ggsave(filename = file.path(plots_output_dir, "LV_genes_top10_controls.png"),
       width = 6, height = 4)
...
#%%
##CSV output
selected_codes <- c("1763", "2265", "3851")
